...
===================================================
Main application module for Tabletop Sage.
Wired components:
- Database initialization and CORS middleware
- Authentication routes (/auth/register, /auth/token, /auth/me)
- Game Bank catalog and rulebook viewer routes (/games)
- User Library management routes (/library)
- System Health check route (/health)
